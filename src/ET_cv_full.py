...
print train.shape
train = train[train['LifeTime'] > 0]
print train.shape
train = train[train['FlightDistance'] > 0]
print train.shape
...
if ind == 1:
  ...
  submission.to_csv("predictions/ET_calib.csv", index=False)
